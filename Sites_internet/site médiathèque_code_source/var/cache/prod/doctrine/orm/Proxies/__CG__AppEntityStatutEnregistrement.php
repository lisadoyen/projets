 ...
 */
class StatutEnregistrement extends \App\Entity\StatutEnregistrement implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\StatutEnregistrement' . "\0" . 'id', '' . "\0" . 'App\\Entity\\StatutEnregistrement' . "\0" . 'libelle', '' . "\0" . 'App\\Entity\\StatutEnregistrement' . "\0" . 'enregistrements'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (StatutEnregistrement $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setLibelle(string $libelle): \App\Entity\StatutEnregistrement
    {
     ...
     * {@inheritDoc}
     */
    public function addEnregistrement(\App\Entity\Enregistrement $enregistrement): \App\Entity\StatutEnregistrement
    {
     ...
     * {@inheritDoc}
     */
    public function removeEnregistrement(\App\Entity\Enregistrement $enregistrement): \App\Entity\StatutEnregistrement
    {
