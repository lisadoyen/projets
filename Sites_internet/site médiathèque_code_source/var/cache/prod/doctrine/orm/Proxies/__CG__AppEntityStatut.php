...
class Statut extends \App\Entity\Statut implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Statut' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Statut' . "\0" . 'libelle', '' . "\0" . 'App\\Entity\\Statut' . "\0" . 'articles'];
        }
     ...
     * {@inheritDoc}
     */
    public function addArticle(\App\Entity\Article $article): \App\Entity\Statut
    {
     ...
     * {@inheritDoc}
     */
    public function removeArticle(\App\Entity\Article $article): \App\Entity\Statut
    {
