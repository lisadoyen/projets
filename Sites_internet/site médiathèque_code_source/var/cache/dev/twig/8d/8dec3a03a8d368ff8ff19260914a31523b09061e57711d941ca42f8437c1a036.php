...
class __TwigTemplate_bd060f51dd3f02f8a4bfec6cdfef68080fae9bbbef04dd09fb0a6e64bd8eb6de extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        echo "\" onsubmit=\"return confirm('Déclasser l\\'article le rendra \\'vendable\\' mais ne le supprimera pas de la BDD');\">
    ...
    <input type=\"hidden\" name=\"_token\" value=\"";
        ...
        echo "\">
    <button class=\"edit-btn\">Déclasser</button>
</form>
";
    ...
    {
        return new Source("<form method=\"post\" action=\"{{ path('article_delete', {'id': article.id}) }}\" onsubmit=\"return confirm('Déclasser l\\'article le rendra \\'vendable\\' mais ne le supprimera pas de la BDD');\">
    <input type=\"hidden\" name=\"_method\" value=\"DELETE\">
    <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ article.id) }}\">
    <button class=\"edit-btn\">Déclasser</button>
</form>
", "article/_delete_form.html.twig", "/home/lisa/Documents/test/projet/templates/article/_delete_form.html.twig");
    }
}
